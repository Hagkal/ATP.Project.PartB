...
public class RunCommunicateWithServers {
    public static void main(String[] args) {
        ...
        //Server.Configurations.setProperty("mazeType","simpleMaze");
        Server.Configurations.setProperty("mazeType", "regularMaze");
        Server.Configurations.setProperty("searchingAlgorithm", "BreadthFirstSearch");
        //Server.Configurations.setProperty();
